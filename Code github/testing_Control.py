...
def main_test_Control(approach,split_type, patient, data_list, datetimes_list, seizure_onset_list, SPH, final_SOP_list, window_size):
    ...
    for SOP in SOP_list: # for fixed SOP
        ...
        # --- Figure: test ---
        fig_test(patient, SOP, target, prediction, firing_power, firing_power_threshold, alarm, 'Approach A', split_type)
