...
# Scripts
from auxiliary_func import construct_target, cut_sph, performance
...
def main_test_approachB_C(approach, split_type, patient, data_list, datetimes_list, seizure_onset_list, SPH, final_SOP_list, window_size):
    ...
    info_test = []
    for SOP in SOP_list: # for fixed SOP
        ...
        # --- Figure: test ---
        fig_test(patient, SOP, target, prediction, firing_power, firing_power_threshold, alarm, approach, split_type)
